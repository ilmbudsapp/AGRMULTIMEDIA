...
export const translations: Record<Language, Translations> = {
  sr: {
    ...
    hero: {
      ...
      subtitle: "Profesionalne usluge web dizajna, grafičkog dizajna, video produkcije i digitalnog marketinga za vaš biznis",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "Professional web design, graphic design, video production and digital marketing services for your business",
  ...
  de: {
    ...
    hero: {
      ...
      subtitle: "Professionelle Webdesign-, Grafikdesign-, Videoproduktions- und Digital Marketing-Services für Ihr Unternehmen",
  ...
  sq: {
    ...
    hero: {
      ...
      subtitle: "Shërbime profesionale të web dizajnit, dizajnit grafik, prodhimit të videove dhe marketingut dixhital për biznesin tuaj",
