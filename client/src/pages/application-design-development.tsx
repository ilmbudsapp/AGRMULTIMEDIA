...
const copyByLang: Record<ServiceLang, AppPageCopy> = {
  ...
  it: {
    ...
    examplesTitle: "Project preview",
    examplesIntro: "Ho creato l'app ILMBUDS — anteprima progetto con screenshot UI e pubblicazione su Google Play.",
    ctaTitle: "Need a custom application for your business?",
    ctaText: "Let's build it together.",
  ...
  sr: {
    ...
    examplesIntro: "Ja sam kreirao ILMBUDS aplikaciju — pregled projekta sa UI screenshot-ovima i Google Play objavom.",
    ctaTitle: "Need a custom application for your business?",
    ctaText: "Let's build it together.",
  ...
  al: {
    ...
    examplesTitle: "Project preview",
    examplesIntro: "Unë e kam krijuar aplikacionin ILMBUDS — preview projekti me pamje UI dhe publikim në Google Play.",
    ctaTitle: "Need a custom application for your business?",
    ctaText: "Let's build it together.",
