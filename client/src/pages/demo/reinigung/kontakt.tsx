      ...
      <section className="px-4 py-12 md:px-8 md:py-16">
        <div className="mx-auto max-w-3xl">
          <MagicWipe className="text-center">
            <h1 className="reinigung-display text-4xl font-extrabold text-slate-900 md:text-5xl">Kontakt</h1>
            <p className="mt-4 text-lg text-slate-600">
              Sichern Sie sich jetzt Ihren Termin für die Frühlingsaktion — schnell und unkompliziert per WhatsApp.
            </p>
            <p className="mt-2 text-sm font-semibold uppercase tracking-[0.12em] text-teal-600">{LOCATION_LINE}</p>
          </MagicWipe>
          ...
          <MagicWipe className="mt-10" delay={0.08}>
            <GlassCard className="flex flex-col items-center gap-6 text-center">
              ...
              <div className="w-full border-t border-cyan-100/80 pt-6">
                <p className="text-sm font-medium text-slate-500">Oder telefonisch:</p>
                <a
                  href={PHONE_TEL}
                  className="reinigung-display mt-2 inline-flex items-center gap-2 text-2xl font-bold text-slate-900 transition hover:text-cyan-700"
                >
              ...
              <p className="text-sm text-slate-500">
                WhatsApp-Link:{" "}
                <a href={WA_HREF} className="font-semibold text-cyan-700 hover:underline" target="_blank" rel="noopener noreferrer">
                  wa.me/4915259534456
                </a>
              </p>
            </GlassCard>
          ...
          <MagicWipe className="mt-8" delay={0.14}>
            <GlassCard className="text-center text-sm text-slate-600">
              <p>
