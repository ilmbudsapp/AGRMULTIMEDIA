...
export default function DemoWhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      className="fixed z-[60] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_32px_rgba(37,211,102,0.45)] [bottom:calc(1.25rem+env(safe-area-inset-bottom,0px))] [right:calc(1.25rem+env(safe-area-inset-right,0px))] md:h-16 md:w-16"
