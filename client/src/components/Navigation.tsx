        ...
        <div className="flex h-14 w-full min-w-0 items-center justify-between gap-6 md:h-16 md:gap-8">
          ...
          <div className="flex min-w-0 shrink items-center">
            ...
            >
              ...
              <span className="flex min-w-0 flex-col text-[10px] font-medium uppercase leading-[1.15] tracking-[0.04em] text-[#5da3f9] sm:text-[9px] md:leading-tight md:tracking-[0.05em] lg:text-[9px] xl:text-[10px] 2xl:text-xs">
